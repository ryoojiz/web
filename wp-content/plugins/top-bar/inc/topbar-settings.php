...
function register_tpbr_settings() {
  ...
  register_setting( 'tpbr-settings-group', 'tpbr_btn_behavior' );
  register_setting( 'tpbr-settings-group', 'tpbr_detect_sticky' );
...
<div class="tpbr_wrap">
  <h1>Top Bar settings
      <img class="tpbr_logo" src="<?php echo plugins_url('../images/darko.png', __FILE__); ?>" draggable="false" style="-moz-user-select: none;"/>
  </h1>
  <div class="tpbr_inner">
      ...
      <form method="post" action="options.php">
          ...
          <h3 class="no-b-top"><?php echo __( 'General', 'top-bar' );?></h3>
          ...
          <div class="tpbr_settings_box">
              <div class="tpbr_settings_item one-third startbit">
                  ...
                  <p><?php echo __( 'If inactive, this prevents the Top Bar from displaying on your site (takes over all other settings).', 'top-bar' );?></p>
              </div>
              ...
              <div class="tpbr_settings_item one-third endbit">
                  <h4><?php echo __( 'Detect fixed navigation', 'top-bar' );?> <span class="tpbr_new">[NEW]</span> <span class="tpbr_beta">[BETA]</span></h4>
                  <?php $current_detect_sticky = esc_attr( get_option('tpbr_detect_sticky') ); ?>
                  <select class="tpbr_detect_sticky" name="tpbr_detect_sticky">
                          <?php if ($current_detect_sticky == '0') { ?>
                              <option value="1"><?php echo __( 'Enabled', 'top-bar' );?></option>
                              <option value="0" selected><?php echo __( 'Disabled', 'top-bar' );?></option>
                          <?php } else if ($current_detect_sticky == '1') { ?>
                              <option value="1" selected><?php echo __( 'Enabled', 'top-bar' );?></option>
                              <option value="0"><?php echo __( 'Disabled', 'top-bar' );?></option>
                          <?php } else { ?>
                              <option value="0" selected><?php echo __( 'Disabled', 'top-bar' );?></option>
                              <option value="1"><?php echo __( 'Enabled', 'top-bar' );?></option>
                          <?php } ?>
                  </select>
                  <p><?php echo __( 'If enabled, the plugin will try to check for sticky elements in your site\'s header that may cover or be covered by the Top Bar and fix these issues.', 'top-bar' );?></p>
              </div>
          ...
          <div class="tpbr_settings_box">
              <div class="tpbr_settings_item two-third startbit">
                  ...
                  <p><?php echo __( 'Message to show in your Top Bar.', 'top-bar' );?></p>
              </div> 
              ...
              <div class="tpbr_settings_item one-third endbit">
                  ...
                  <select class="tpbr_yn_button" name="tpbr_yn_button">
                      <?php if ($current_status == 'button') { ?>
                          <option value="button" selected><?php echo __( 'Enabled', 'top-bar' );?></option>
                          <option value="nobutton"><?php echo __( 'Disabled', 'top-bar' );?></option>
                      <?php } else if ($current_status == 'nobutton') { ?>
                          <option value="nobutton" selected><?php echo __( 'Disabled', 'top-bar' );?></option>
                          <option value="button"><?php echo __( 'Enabled', 'top-bar' );?></option>
                      <?php } else { ?>
                          <option value="nobutton" selected><?php echo __( 'Disabled', 'top-bar' );?></option>
                          <option value="button"><?php echo __( 'Enabled', 'top-bar' );?></option>
                      <?php } ?>
              ...
              <div class='tpbr_button_box'>
                  ...
                  <h3><?php echo __( 'Button settings', 'top-bar' );?></h3>
                  
                  <div class="tpbr_settings_item one-third startbit">
                      <h4><?php echo __( 'Button text', 'top-bar' );?></h4>
                      ...
                      <p><?php echo __( 'Text inside the button.', 'top-bar' );?></p>
                  </div>
                  <div class="tpbr_settings_item one-third">
                      <h4><?php echo __( 'Button URL', 'top-bar' );?></h4>
                      ...
                      <p><?php echo __( 'Link used when the button is clicked.', 'top-bar' );?></p>
                  </div>
                  <div class="tpbr_settings_item one-third endbit">
                      <h4><?php echo __( 'Link behavior', 'top-bar' );?> <span class="tpbr_new">[NEW]</span></h4>
                      <?php $current_behavior = esc_attr( get_option('tpbr_btn_behavior') ); ?>
                      <select class="tpbr_btn_behavior" name="tpbr_btn_behavior">
                          <?php if ($current_behavior == 'newwindow') { ?>
                              <option value="newwindow" selected><?php echo __( 'New window', 'top-bar' );?></option>
                              <option value="samewindow"><?php echo __( 'Same window', 'top-bar' );?></option>
                          <?php } else { ?>
                              <option value="samewindow" selected><?php echo __( 'Same window', 'top-bar' );?></option>
                              <option value="newwindow"><?php echo __( 'New window', 'top-bar' );?></option>
                          <?php } ?>
                      </select>
                      <p><?php echo __( 'Button behavior when clicked.', 'top-bar' );?></p>
                  </div>
                  <div style="clear: both;"></div>
              </div>
              <div style="clear: both;"></div>
          ...
          <div class="tpbr_section_box">
          <h3><?php echo __( 'Visibility & Styling', 'top-bar' );?></h3>

          <div class="tpbr_settings_box">

             <div class="tpbr_settings_item one-third startbit">
                  <h4><?php echo __( 'User visibility', 'top-bar' );?></h4>
                  ...
                  <select class="tpbr_guests_or_users" name="tpbr_guests_or_users">
                      <?php if ($current_status == 'all') { ?>
                          <option value="all" selected><?php echo __( 'Everyone', 'top-bar' );?></option>
                      ...
                      <?php } else if ($current_status == 'guests') { ?>
                          <option value="all"><?php echo __( 'Everyone', 'top-bar' );?></option>
                  ...
                  <p><?php echo __( 'Defines who can see the Top Bar.', 'top-bar' );?></p>
              </div>

              <div class="tpbr_settings_item two-third endbit">
                  <?php $current_color = esc_attr( get_option('tpbr_color') ); ?>
                  <h4 style="margin-bottom:5px;"><?php echo __( 'Color', 'top-bar' );?></h4>
                  ...
                  <p><?php echo __( 'Used for the Top Bar\'s background and button.', 'top-bar' );?></p>
              </div>
          ...
          <h3><?php echo __( 'PRO version', 'top-bar' );?></h3>
            ...
            <div class="tpbr_settings_box">
                ...
                <p>
                        This is a free plugin and it is not limited. PRO features can be seen above or at WPDarko.com.
                </p>
                <a class="tpbr_pro_button" target="_blank" href="https://wpdarko.com/items/top-bar-pro/">See all the PRO features</a>
